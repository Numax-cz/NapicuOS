...
export const lang_enter_new_name_en = "Enter the new name";
export const lang_enter_new_name_cs = "Zadejte nový název";

export const lang_rename_en = "Rename";
export const lang_rename_cs = "Přejmenovat";
...
export const lang_activities_en = "Activities";
export const lang_activities_cs = "Činnosti";
...
export const lang_pass_error_cs = "Heslo je nesprávné";
...
export const lang_type_en = "Type";
export const lang_type_cs = "Typ";
