...
import {
  ...
  lang_installation_done_cs,
  lang_installation_done_en,
  ...
  lang_verify_cs,
  lang_verify_en,
  lang_verify_root_pass_cs,
  lang_verify_root_pass_en,
...
import {
  ...
  lang_NapicuApi_server_error_en,
  lang_NapicuApi_too_many_req_cs,
...
export const NapicuOSLanguages = {
  en: {
    ...
    other: {
      ...
      device_restart: lang_device_restart_en,
  ...
  cz: {
    ...
    other: {
      ...
      device_restart: lang_device_restart_cs,
